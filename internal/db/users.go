...
func (d *DB) GetUser(ctx context.Context, username, hostname string) (user domain.UserCore, err error) {
	if hostname == "" {
...
func (d *DB) GetProfile(ctx context.Context, username, hostname string) (p domain.Profile, err error) {
