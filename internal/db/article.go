...
type Article interface {
	ArticleTitleExists(ctx context.Context, title string) (bool, error)
	...
	GetArticleIdByIRI(ctx context.Context, IRI *url.URL) (int64, error)
	GetArticleById(ctx context.Context, id int64) (domain.ArticleFed, error)
	GetArticleByIRI(ctx context.Context, IRI *url.URL) (domain.ArticleFed, error)
